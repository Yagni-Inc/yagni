    ...
    public static void addRecord(String productIdIn, int quantityIn, float wholesaleCostIn, float salePriceIn,
        ...
        try {
            buffWrite = new BufferedWriter(new FileWriter(fileName, true)); // Setting our buffered writer to the
                                                                            // correct file
            buffWrite.write(productId + "," + quantity + "," + wholesaleCost + "," + salePrice + "," + supplierId); // Writing
                                                                                                                    // to
                                                                                                                    // the
                                                                                                                    // file
            buffWrite.flush();
            buffWrite.newLine();
            buffWrite.close();
            System.out.println("Added " + productId + "," + quantity + "," + wholesaleCost + "," + salePrice + ","
                    + supplierId + " to the inventory!\n");
        } catch (IOException e) {
